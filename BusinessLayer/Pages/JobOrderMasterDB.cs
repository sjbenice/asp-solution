...
namespace BusinessLayer.Pages
{
	public class JobOrderMasterDB : DBBase<JobOrderMaster, List<JobOrderMaster>, long>
	{
		...
		public bool Delete(JobOrderMaster entity)
		{
            ...
            int TransactionTypeID = 11111;
            AttachedFiles attachedFiles = attachedFilesDB.GetAttachment(entity.JobOrderMasterID, TransactionTypeID);
		...
		{
			// change ViewJobOrderPendingToInvoicer view to prevent showing the deleted Sample Receive 
