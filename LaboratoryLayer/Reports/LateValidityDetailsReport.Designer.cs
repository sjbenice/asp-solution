...
namespace LaboratoryLayer.Reports
{
	public class LateValidityDetailsReport : XtraReport
	{
		...
		private void InitializeComponent()
		{
			...
			XRControl[] xRControlArrays = new XRControl[] { this.xrLabel4, this.xrLabel5, this.xrLabel6, this.xrLabel10, this.xrLabel26 };
			...
			XRBindingCollection dataBindings5 = this.xrLabel5.DataBindings;
			XRBinding[] xRBinding5 = new XRBinding[] { new XRBinding("Text", null, "ValidityListDetails.ValidityCode") };
			...
			XRBindingCollection xRBindingCollections5 = this.xrLabel6.DataBindings;
			XRBinding[] xRBindingArray5 = new XRBinding[] { new XRBinding("Text", null, "ValidityListDetails.ValidityName") };
			xRBindingCollections5.AddRange(xRBindingArray5);
			this.xrLabel6.Dpi = 100f;
			this.xrLabel6.ForeColor = Color.FromArgb(0, 0, 0);
			this.xrLabel6.LocationFloat = new PointFloat(416.1455f, 39.20832f);
			...
			base.Landscape = true;
			base.Margins = new System.Drawing.Printing.Margins(0, 2, 14, 3);
			base.PageHeight = 850;
			base.PageWidth = 1100;
