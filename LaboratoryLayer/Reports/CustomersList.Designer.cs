...
namespace LaboratoryLayer.Reports
{
	public class CustomersList : XtraReport
	{
		...
		private void InitializeComponent()
		{
			...
			XRTableCell[] xRTableCellArray = new XRTableCell[] { this.xrTableCell8, this.xrTableCell9, this.xrTableCell10, this.xrTableCell11, this.xrTableCell12, this.xrTableCell13, this.xrTableCell14 };
			cells.AddRange(xRTableCellArray);
			this.xrTableRow2.Dpi = 100f;
			this.xrTableRow2.Name = "xrTableRow2";
			this.xrTableRow2.Weight = 11.5;
			XRBindingCollection dataBindings = this.xrTableCell8.DataBindings;
			XRBinding[] xRBinding = new XRBinding[] { new XRBinding("Text", null, "CustomersList.CustomerCode") };
			dataBindings.AddRange(xRBinding);
			this.xrTableCell8.Dpi = 100f;
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.Text = "xrTableCell8";
			this.xrTableCell8.Weight = 0.477941176470588;
			XRBindingCollection xRBindingCollections = this.xrTableCell9.DataBindings;
			XRBinding[] xRBindingArray = new XRBinding[] { new XRBinding("Text", null, "CustomersList.CustomerName") };
			xRBindingCollections.AddRange(xRBindingArray);
			this.xrTableCell9.Dpi = 100f;
			this.xrTableCell9.Name = "xrTableCell9";
			this.xrTableCell9.Text = "xrTableCell9";
			this.xrTableCell9.Weight = 1.19281068091299;
			XRBindingCollection dataBindings1 = this.xrTableCell10.DataBindings;
			XRBinding[] xRBinding1 = new XRBinding[] { new XRBinding("Text", null, "CustomersList.PhoneNumber") };
			dataBindings1.AddRange(xRBinding1);
			this.xrTableCell10.Dpi = 100f;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "xrTableCell10";
			this.xrTableCell10.Weight = 0.386437713024663;
			XRBindingCollection xRBindingCollections1 = this.xrTableCell11.DataBindings;
			XRBinding[] xRBindingArray1 = new XRBinding[] { new XRBinding("Text", null, "CustomersList.Email") };
			xRBindingCollections1.AddRange(xRBindingArray1);
			this.xrTableCell11.Dpi = 100f;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.Text = "xrTableCell11";
			this.xrTableCell11.Weight = 0.718835844152114;
			XRBindingCollection dataBindings2 = this.xrTableCell12.DataBindings;
			XRBinding[] xRBinding2 = new XRBinding[] { new XRBinding("Text", null, "CustomersList.ContactName") };
			dataBindings2.AddRange(xRBinding2);
			this.xrTableCell12.Dpi = 100f;
			this.xrTableCell12.Name = "xrTableCell12";
			this.xrTableCell12.Text = "xrTableCell12";
			this.xrTableCell12.Weight = 0.759660297468597;
			XRBindingCollection xRBindingCollections2 = this.xrTableCell13.DataBindings;
			XRBinding[] xRBindingArray2 = new XRBinding[] { new XRBinding("Text", null, "CustomersList.Column15") };
			xRBindingCollections2.AddRange(xRBindingArray2);
			this.xrTableCell13.Dpi = 100f;
			this.xrTableCell13.Name = "xrTableCell13";
			this.xrTableCell13.Weight = 0.59584945379519;
			XRBindingCollection dataBindings3 = this.xrTableCell14.DataBindings;
			XRBinding[] xRBinding3 = new XRBinding[] { new XRBinding("Text", null, "CustomersList.Column14") };
			dataBindings3.AddRange(xRBinding3);
			this.xrTableCell14.Dpi = 100f;
			this.xrTableCell14.Name = "xrTableCell14";
			this.xrTableCell14.Weight = 0.361815353094363;
			...
			XRTableCell[] xRTableCellArray1 = new XRTableCell[] { this.xrTableCell1, this.xrTableCell2, this.xrTableCell3, this.xrTableCell4, this.xrTableCell5, this.xrTableCell6, this.xrTableCell7 };
			...
			this.xrTableCell1.Weight = 0.477941050809972;
			this.xrTableCell2.Dpi = 100f;
			this.xrTableCell2.Name = "xrTableCell2";
			this.xrTableCell2.Text = "Customer Name";
			this.xrTableCell2.Weight = 1.19281063902612;
			...
			this.xrTableCell4.Weight = 0.718835341509651;
			this.xrTableCell5.Dpi = 100f;
			this.xrTableCell5.Name = "xrTableCell5";
			this.xrTableCell5.Text = "Contact Name";
			this.xrTableCell5.Weight = 0.759660967658548;
			this.xrTableCell6.Dpi = 100f;
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.Text = "Creditor Mode";
			this.xrTableCell6.Weight = 0.59584945379519;
			this.xrTableCell7.Dpi = 100f;
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "Inactive";
			this.xrTableCell7.Weight = 0.361814682904412;
			...
			base.Margins = new System.Drawing.Printing.Margins(0, 10, 130, 143);
