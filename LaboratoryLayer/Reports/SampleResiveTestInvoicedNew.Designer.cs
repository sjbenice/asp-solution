...
namespace LaboratoryLayer.Reports
{
    partial class SampleResiveTestInvoicedNew
    {
        ...
        private void InitializeComponent()
        {
            ...
            queryParameter1.Value = new DevExpress.DataAccess.Expression("[Parameters.InvoiceId]", typeof(int));
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Query.prize", "{0:n2}")});
