...
namespace LaboratoryLayer.Reports
{
	public class ProjectsList : XtraReport
	{
		...
		public ProjectsList()
		{
			...
			this.BeforePrint += new PrintEventHandler(this.ProjectsList_BeforePrint);
		}
		...
		private void InitializeComponent()
		{
			...
			XRTableCell[] xRTableCellArray = new XRTableCell[] { this.xrTableCell10, this.xrTableCell11, this.xrTableCell12, this.xrTableCell13, this.xrTableCell14, this.xrTableCell15, this.xrTableCell16, this.xrTableCell17, this.xrTableCell18 };
			cells.AddRange(xRTableCellArray);
			this.xrTableRow2.Dpi = 100f;
			this.xrTableRow2.Name = "xrTableRow2";
			this.xrTableRow2.Weight = 11.5;
			XRBindingCollection dataBindings = this.xrTableCell10.DataBindings;
			XRBinding[] xRBinding = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.ProjectCode") };
			dataBindings.AddRange(xRBinding);
			this.xrTableCell10.Dpi = 100f;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "xrTableCell10";
			this.xrTableCell10.Weight = 0.0785675128591691;
			XRBindingCollection xRBindingCollections = this.xrTableCell11.DataBindings;
			XRBinding[] xRBindingArray = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.ProjectName") };
			xRBindingCollections.AddRange(xRBindingArray);
			this.xrTableCell11.Dpi = 100f;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.Text = "xrTableCell11";
			this.xrTableCell11.Weight = 0.176038062283737;
			XRBindingCollection dataBindings1 = this.xrTableCell12.DataBindings;
			XRBinding[] xRBinding1 = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.ProjectOwner") };
			dataBindings1.AddRange(xRBinding1);
			this.xrTableCell12.Dpi = 100f;
			this.xrTableCell12.Name = "xrTableCell12";
			this.xrTableCell12.Text = "xrTableCell12";
			this.xrTableCell12.Weight = 0.133218012087073;
			XRBindingCollection xRBindingCollections1 = this.xrTableCell13.DataBindings;
			XRBinding[] xRBindingArray1 = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.AshghalCode") };
			xRBindingCollections1.AddRange(xRBindingArray1);
			this.xrTableCell13.Dpi = 100f;
			this.xrTableCell13.Name = "xrTableCell13";
			this.xrTableCell13.Text = "xrTableCell13";
			this.xrTableCell13.Weight = 0.121539735365079;
			XRBindingCollection dataBindings2 = this.xrTableCell14.DataBindings;
			XRBinding[] xRBinding2 = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.StartDate", "{0:dd MMM yyyy}") };
			dataBindings2.AddRange(xRBinding2);
			this.xrTableCell14.Dpi = 100f;
			this.xrTableCell14.Name = "xrTableCell14";
			this.xrTableCell14.Text = "xrTableCell14";
			this.xrTableCell14.Weight = 0.111004759052633;
			XRBindingCollection xRBindingCollections2 = this.xrTableCell15.DataBindings;
			XRBinding[] xRBindingArray2 = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.EndDate", "{0:dd MMM yyyy}") };
			xRBindingCollections2.AddRange(xRBindingArray2);
			this.xrTableCell15.Dpi = 100f;
			this.xrTableCell15.Name = "xrTableCell15";
			this.xrTableCell15.Text = "xrTableCell15";
			this.xrTableCell15.Weight = 0.107420859155358;
			...
			this.xrTableCell16.Weight = 0.109861534673037;
			XRBindingCollection xRBindingCollections3 = this.xrTableCell17.DataBindings;
			XRBinding[] xRBindingArray3 = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.ProjectLocation") };
			xRBindingCollections3.AddRange(xRBindingArray3);
			this.xrTableCell17.Dpi = 100f;
			this.xrTableCell17.Name = "xrTableCell17";
			this.xrTableCell17.Text = "xrTableCell17";
			this.xrTableCell17.Weight = 0.129325354553011;
			XRBindingCollection dataBindings4 = this.xrTableCell18.DataBindings;
			XRBinding[] xRBinding4 = new XRBinding[] { new XRBinding("Text", null, "ProjectsList.Column14") };
			dataBindings4.AddRange(xRBinding4);
			this.xrTableCell18.Dpi = 100f;
			this.xrTableCell18.Name = "xrTableCell18";
			this.xrTableCell18.Weight = 0.0826124567474048;
			...
			XRTableCell[] xRTableCellArray1 = new XRTableCell[] { this.xrTableCell1, this.xrTableCell2, this.xrTableCell3, this.xrTableCell4, this.xrTableCell5, this.xrTableCell6, this.xrTableCell7, this.xrTableCell8, this.xrTableCell9 };
			...
			this.xrTableCell1.Weight = 0.0785675128591691;
			this.xrTableCell2.Dpi = 100f;
			this.xrTableCell2.Name = "xrTableCell2";
			this.xrTableCell2.Text = "Project Name";
			this.xrTableCell2.Weight = 0.176038062283737;
			this.xrTableCell3.Dpi = 100f;
			this.xrTableCell3.Name = "xrTableCell3";
			this.xrTableCell3.Text = "Project Owner";
			this.xrTableCell3.Weight = 0.133218012087073;
			this.xrTableCell4.Dpi = 100f;
			this.xrTableCell4.Name = "xrTableCell4";
			this.xrTableCell4.Text = "Ashghal Code";
			this.xrTableCell4.Weight = 0.121539773380055;
			this.xrTableCell5.Dpi = 100f;
			this.xrTableCell5.Name = "xrTableCell5";
			this.xrTableCell5.Text = "Start Date";
			this.xrTableCell5.Weight = 0.111004797067609;
			this.xrTableCell6.Dpi = 100f;
			this.xrTableCell6.Name = "xrTableCell6";
			this.xrTableCell6.Text = "End Date";
			this.xrTableCell6.Weight = 0.107420859155358;
			this.xrTableCell7.Dpi = 100f;
			this.xrTableCell7.Name = "xrTableCell7";
			this.xrTableCell7.Text = "Project Type ";
			this.xrTableCell7.Weight = 0.109861534673037;
			this.xrTableCell8.Dpi = 100f;
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.Text = "Location";
			this.xrTableCell8.Weight = 0.129325278523059;
			this.xrTableCell9.Dpi = 100f;
			this.xrTableCell9.Name = "xrTableCell9";
			this.xrTableCell9.Text = "Inactive";
			this.xrTableCell9.Weight = 0.0826124567474048;
			...
			base.Margins = new System.Drawing.Printing.Margins(2, 5, 130, 143);
