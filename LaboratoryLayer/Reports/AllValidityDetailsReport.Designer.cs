...
namespace LaboratoryLayer.Reports
{
	public class ValidValidityDetailsReport : XtraReport
	{
		...
		private void InitializeComponent()
		{
			...
			XRTableCell[] xRTableCellArray1 = new XRTableCell[] { this.xrTableCell8, this.xrTableCell18, this.xrTableCell19, this.xrTableCell20, this.xrTableCell21, this.xrTableCell22, this.xrTableCell23, this.xrTableCell25, this.xrTableCell10, this.xrTableCell14 };
			...
			base.Landscape = true;
			base.Margins = new System.Drawing.Printing.Margins(0, 2, 22, 0);
			base.PageHeight = 850;
			base.PageWidth = 1100;
