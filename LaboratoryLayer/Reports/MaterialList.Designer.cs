...
namespace LaboratoryLayer.Reports
{
	public class MaterialList : XtraReport
	{
		...
		public MaterialList()
		{
			...
			this.BeforePrint += new PrintEventHandler(this.MaterialList_BeforePrint);
		}
		...
		private void InitializeComponent()
		{
			...
			XRBinding[] xRBinding = new XRBinding[] { new XRBinding("Text", null, "MaterialsDetails.MaterialName") };
			...
			XRBinding[] xRBindingArray = new XRBinding[] { new XRBinding("Text", null, "MaterialsDetails.MaterialsTypes_MaterialName") };
			xRBindingCollections.AddRange(xRBindingArray);
			this.xrTableCell8.Dpi = 100f;
			this.xrTableCell8.Name = "xrTableCell8";
			this.xrTableCell8.Text = "xrTableCell8";
			this.xrTableCell8.Weight = 0.417647575827206;
			XRBindingCollection dataBindings1 = this.xrTableCell9.DataBindings;
			XRBinding[] xRBinding1 = new XRBinding[] { new XRBinding("Text", null, "MaterialsDetails.MaterialUse") };
			dataBindings1.AddRange(xRBinding1);
			this.xrTableCell9.Dpi = 100f;
			this.xrTableCell9.Name = "xrTableCell9";
			this.xrTableCell9.Text = "xrTableCell9";
			this.xrTableCell9.Weight = 0.371218276079963;
			XRBindingCollection xRBindingCollections1 = this.xrTableCell10.DataBindings;
			XRBinding[] xRBindingArray1 = new XRBinding[] { new XRBinding("Text", null, "MaterialsDetails.StandardSpecs") };
			xRBindingCollections1.AddRange(xRBindingArray1);
			this.xrTableCell10.Dpi = 100f;
			this.xrTableCell10.Name = "xrTableCell10";
			this.xrTableCell10.Text = "xrTableCell10";
			this.xrTableCell10.Weight = 0.361134464039522;
			XRBindingCollection dataBindings2 = this.xrTableCell11.DataBindings;
			XRBinding[] xRBinding2 = new XRBinding[] { new XRBinding("Text", null, "MaterialsDetails.StandardNumber") };
			dataBindings2.AddRange(xRBinding2);
			this.xrTableCell11.Dpi = 100f;
			this.xrTableCell11.Name = "xrTableCell11";
			this.xrTableCell11.Text = "xrTableCell11";
			this.xrTableCell11.Weight = 0.326470573874081;
			XRBindingCollection xRBindingCollections2 = this.xrTableCell12.DataBindings;
			XRBinding[] xRBindingArray2 = new XRBinding[] { new XRBinding("Text", null, "MaterialsDetails.Column9") };
			...
			this.reportHeaderBand1.Controls.AddRange(new XRControl[] { this.xrLabel18 });
			...
			base.Margins = new System.Drawing.Printing.Margins(0, 16, 130, 123);
