...
namespace LaboratoryLayer.Reports
{
	...
	public class SampleReceiptReport : XtraReport
	{
		...
		private void InitializeComponent()
		{
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", this.realTimeSource1, "calculatedField1", "{0:dd MMM yyyy}")});
            ...
            this.xrTable2.LocationFloat = new DevExpress.Utils.PointFloat(1F, 50F);
            ...
            // calculatedField1
            // 
            this.calculatedField1.DataSource = this.realTimeSource1;
            this.calculatedField1.Expression = "LocalDateTimeNow()";
