<%@ Page Language="C#" AutoEventWireup="true" Inherits="Login" CodeBehind="Login.aspx.cs" EnableEventValidation="false" %>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login Page - Laboratory System Management</title>
                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <i class="">
                                        <img src="images/LoginImages/Lab Logo.jpeg" height="130" width="380" /></i>
                                    <%--<span class="red">PLSM</span>
                                    <span class="grey" id="id-text2">Laboratory System Management</span>--%>
                                </h1>
                                <h4 class="blue" id="id-company-text">&copy; Owned by Laboratory</h4>
                            </div>
