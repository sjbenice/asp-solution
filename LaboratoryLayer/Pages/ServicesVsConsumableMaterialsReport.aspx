<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="ServicesVsConsumableMaterialsReport.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.ServicesVsConsumableMaterialsReport" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <dx:ASPxLabel ID="lblError" runat="server" ClientInstanceName="lblError" Text="" ForeColor="Red" Font-Size="Larger"></dx:ASPxLabel>
    <dx:ASPxDocumentViewer ID="ReportViewer1" runat="server" BackColor="Transparent" Height="800px" Width="100%" ZoomMode="Percent"
         ZoomPercent="100" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" 
        ProcessingMode="Remote" ShowParameterPrompts="False" SettingsSplitter-SidePaneVisible="false" ToolBarItemBorderStyle="Solid">
