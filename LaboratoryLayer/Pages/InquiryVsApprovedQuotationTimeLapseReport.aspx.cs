...
namespace LaboratoryLayer.Pages.Reports
{
	public class InquiryVsApprovedQuotationTimeLapseReport : Page
	{
		...
		{
            LaboratoryLayer.Reports.Menu.InquiryVsApprovedQuotationTimeLapseReport inquiryVsApprovedQuotationTimeLapse = new LaboratoryLayer.Reports.Menu.InquiryVsApprovedQuotationTimeLapseReport();
            if (dtDateFrom.Text != "")
