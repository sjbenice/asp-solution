<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReportViwer.aspx.cs" Inherits="LaboratoryLayer.Pages.ReportViwer" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <dx:ASPxDocumentViewer SettingsReportViewer-PrintUsingAdobePlugIn="true" ID="ReportViewer1" runat="server" >
