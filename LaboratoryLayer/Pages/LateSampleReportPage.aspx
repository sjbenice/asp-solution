<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="LateSampleReportPage.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.LateSampleReportPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagePath" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb" runat="server" id="ultitle">
            ...
            <li class="active" id="menulink">Late Sample Report</li>
        </ul>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageHeader" runat="server">
    <div class="page-header">
        <h1>Late Sample Report</h1>
    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
        ...
        <div style="width: 1000px; float: left; position: relative; padding-left: 10px">
            <div id="divValidityDetails" runat="server" style="clear: left;">
                <table style="width:100%">
                    ...
                    <tr>
                        <td>
                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Test Status" CssClass="lable"></dx:ASPxLabel>
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="cmbTestStatus" runat="server" DropDownStyle="DropDownList" Width="100%"
                                 ValueType="System.String" ClientInstanceName="cmbTestStatus">
                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                </ValidationSettings>
                                <Items>
                                                                                                            <dx:ListEditItem Text="" Value="null" Selected="true" />

                                    <dx:ListEditItem Text="Late" Value="Late" />
                        ...
                        <td>
                            <dx:ASPxButton ID="ASPxButton2" runat="server" Text="X"  AutoPostBack="False" ToolTip="Clear Test Status">
                                <ClientSideEvents Click="function(s, e) { cmbTestStatus.SetValue('null'); }" />
                            </dx:ASPxButton>
                        </td>
                        <td style="text-align:right">
                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Report Status" CssClass="lable"></dx:ASPxLabel>
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="cmbReportStatus" runat="server" DropDownStyle="DropDownList" Width="100%"
                                 ValueType="System.String" ClientInstanceName="cmbReportStatus">
                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                </ValidationSettings>
                                <Items>
                                                                                                            <dx:ListEditItem Text="" Value="null" Selected="true" />
                        ...
                        <td>
                            <dx:ASPxButton ID="ASPxButton3" runat="server" Text="X"  AutoPostBack="False" ToolTip="Clear Report Status">
                                <ClientSideEvents Click="function(s, e) { cmbReportStatus.SetValue('null'); }" />
                            </dx:ASPxButton>
                        </td>
                         <td>
                            <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Total Status" CssClass="lable"></dx:ASPxLabel>
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="cmbTotalStatus" runat="server" DropDownStyle="DropDownList" Width="100%"
                                 ValueType="System.String" ClientInstanceName="cmbTotalStatus">
                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                </ValidationSettings>
                                <Items>
                                                                                                            <dx:ListEditItem Text="" Value="null" Selected="true" />
                        ...
                        <td>
                            <dx:ASPxButton ID="ASPxButton4" runat="server" Text="X"  AutoPostBack="False" ToolTip="Clear Total Status">
                                <ClientSideEvents Click="function(s, e) { cmbTotalStatus.SetValue('null'); }" />
                            </dx:ASPxButton>
                        </td>
    ...
    <dx:ASPxDocumentViewer ID="ReportViewer1" runat="server" BackColor="Transparent" Visible="true" 
