<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="RssInfo.aspx.cs" Inherits="LaboratoryLayer.Pages.RssInfo" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group" role="group" aria-label="First group">
            ...
            <dx:ASPxButton ID="BtnSave" ClientInstanceName="btnSave" runat="server" EnableTheming="false" Text="Save" CssClass="btn btn-round btn-primary fa fa-floppy-o" ValidationGroup="OnSave" OnClick="BtnSave_Click">
                <ClientSideEvents Click="function(s,e)
                    {
                        if (!ASPxClientEdit.ValidateGroup('OnSave')) {
                            ...
                            document.getElementById('divError').className = 'hidden';
