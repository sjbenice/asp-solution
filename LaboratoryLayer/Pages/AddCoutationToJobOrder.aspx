<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="AddCoutationToJobOrder.aspx.cs" Inherits="LaboratoryLayer.Pages.AddCoutationToJobOrder" %>
...
<%--            <dx:ASPxButton ID="BtnUpdate" runat="server" EnableTheming="false" Text="Update" CssClass="btn btn-round btn-primary fa fa-edit"  OnClick="BtnUpdate_Click">
            </dx:ASPxButton>--%>
        </div>
        <div class="btn-group" role="group" aria-label="First group">
            ...
            <Items>
                <dx:LayoutGroup ShowCaption="False" ColCount="8">
                    <Items>
                        ...
                        <dx:LayoutItem Caption="JobOrder No" FieldName="JobOrderMasterID" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox ID="txtJobOrderMasterID" runat="server" ReadOnly="true"></dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Date" FieldName="TransactionDate" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxDateEdit ID="dtTransactionDate" ClientEnabled ="false"  ClientInstanceName="dtTransactionDate"  ReadOnly="true" runat="server" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"></dx:ASPxDateEdit>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        <dx:LayoutItem Caption="Customer Quotation" FieldName="FKQuotationMasterID" ColSpan="3">
                           ...
                           <dx:LayoutItem ShowCaption="False"  ColSpan="1">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                  <dx:ASPxButton ID="btnAddQuotation"  runat="server" Text="Add Quotation">
                        ...
                        <dx:LayoutItem Caption="Customer"  FieldName="FKCustomerID" ColSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbFKCustomerID" ClientEnabled ="false"  runat="server" Width="550" ValueField="CustomerID" TextField="CustomerName"
                        ...
                        <dx:LayoutItem Caption="Project"  FieldName="FKProjectID" ColSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbFKProjectID" runat="server" Width="550" ValueField="ProjectID" ClientEnabled ="false"  TextField="ProjectName"
                        ...
                        <dx:LayoutItem Caption="Expiry Date" FieldName="ExpiryDate" ColSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxDateEdit ID="dtExpiryDate" runat="server" ClientInstanceName="dtExpiryDate" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy">
                                        <ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                ...
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxGridView runat="server" ID="GdvJobOrderDetailsList" AutoGenerateColumns="false" ClientInstanceName="gridJobOrderDetailsList" OnCellEditorInitialize="GdvJobOrderDetailsList_CellEditorInitialize"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataComboBoxColumn FieldName="FKMaterialDetailsID" Caption="Material Details" VisibleIndex="1" ReadOnly="true">
                                                <PropertiesComboBox ValueField="MaterialDetailsID" TextField="MaterialName" DataSourceID="AllMaterialsListDS" DropDownRows="1">
                                                    <DropDownButton ClientVisible="false"></DropDownButton>
                                                </PropertiesComboBox>
                                                <EditFormSettings Visible="False" />
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="FKTestID" Caption="Services Name" VisibleIndex="1" ReadOnly="true">
                                                <PropertiesComboBox ValueField="TestID" TextField="TestName" DataSourceID="TestsListDS" DropDownRows="1">
                                                    <DropDownButton ClientVisible="false"></DropDownButton>
                                                </PropertiesComboBox>
                                                <EditFormSettings Visible="False" />
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="FKTestID" Caption="Standard Number" VisibleIndex="1" ReadOnly="true">
                                            ...
                                            <dx:GridViewDataSpinEditColumn FieldName="Price" Caption="Price" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                            ...
                                            <dx:GridViewDataSpinEditColumn FieldName="MinQty" Caption="Minimum Qty" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                                <PropertiesSpinEdit DecimalPlaces="2"  SpinButtons-ShowIncrementButtons="false" DisplayFormatString="n2">
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="Remarks" Caption="Remarks" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                ...
                <dx:PopupControlContentControl ID="PopupControlContentControl" runat="server">
                    ...
                    <dx:ASPxGridView runat="server" ID="GdvLabTestsList" AutoGenerateColumns="false" Width="100%" ClientInstanceName="gridLabTestsList"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="ShortName" Caption="Short Name" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="StandardNumber" Caption="Standard Number" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewCommandColumn VisibleIndex="4" ButtonType="Default" Width="60" ShowClearFilterButton="true" ShowSelectCheckbox="true">
                            </dx:GridViewCommandColumn>
                        </Columns>
                        <SettingsCommandButton>
                            <ClearFilterButton Text=" " Styles-Style-Font-Size="Medium" Styles-Style-CssClass="fa fa-eraser" />
                ...
                <dx:LayoutGroup ShowCaption="False" ColCount="4">
                    <Items>
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="CmbQuotation" runat="server" Width="200" ValueField="QuotationMasterID" DataSourceID="CustomerQuotaionDS" ValueType="System.Int64"
                                        OnSelectedIndexChanged="CmbQuotation_SelectedIndexChanged" AutoPostBack="true" TextFormatString="{0} - ({1:d}) - {2} - {3}" CssClass="textbox" DropDownStyle="DropDownList">
                                        <ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            <RequiredField IsRequired="true" ErrorText="Select Customer Quotation" />
                                        </ValidationSettings>
                                        <Columns>
                        ...
                        <dx:LayoutItem Caption="Customer"  FieldName="FKCustomerID" ColSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="ASPxComboBox2" ClientEnabled ="false"  runat="server" Width="550" ValueField="CustomerID" TextField="CustomerName"
                                        DataSourceID="CustomersListDS" ValueType="System.Int32" ReadOnly="true">
                                        <%--<ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            <RequiredField IsRequired="true" ErrorText="Select Customer" />
                                        </ValidationSettings>--%>
                        ...
                        <dx:LayoutItem Caption="Project"  FieldName="FKProjectID" ColSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="ASPxComboBox3" runat="server" Width="550" ValueField="ProjectID" ClientEnabled ="false"  TextField="ProjectName"
                                        DataSourceID="ProjectsListDS" ValueType="System.Int32" ReadOnly="true">
                                        <%--<ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            <RequiredField IsRequired="true" ErrorText="Select Project" />
                                        </ValidationSettings>--%>
                ...
                <dx:LayoutGroup ShowCaption="False" ColCount="4">
                    <Items>
                        <dx:LayoutItem Caption=" " ColSpan="4">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxGridView runat="server" ID="GdvCustomerQuotaion" AutoGenerateColumns="false" ClientInstanceName="gdvCustomerQuotaion" OnCellEditorInitialize="GdvJobOrderDetailsList_CellEditorInitialize"
                                        DataSourceID="CustomerJobOrderDetailsDS" KeyFieldName="JobOrderDetailsID"  Width="100%" OnCustomButtonInitialize="GdvJobOrderDetailsList_CustomButtonInitialize">
                                        <Columns>
                                            <dx:GridViewDataComboBoxColumn FieldName="FKMaterialTypeID" Caption="Service Section" VisibleIndex="1" ReadOnly="true">
                                                <PropertiesComboBox ValueField="MaterialTypeID" TextField="MaterialName" DataSourceID="MaterialsTypesDS" DropDownRows="1">
                                                    <DropDownButton ClientVisible="false"></DropDownButton>
                                            ...
                                            <dx:GridViewCommandColumn VisibleIndex="4" ButtonType="Default" Width="60"
                                                ...
                                                <CustomButtons>
                                                    <dx:GridViewCommandColumnCustomButton ID="GridViewCommandColumnCustomButton1" Text=" ">
                                                        <Styles>
                                                            <Style Font-Size="Medium" CssClass="glyphicon glyphicon-list-alt"></Style>
                                                        </Styles>
                                                    </dx:GridViewCommandColumnCustomButton>
                                            ...
                                            <dx:LayoutGroup Caption="Work Order Details" ColCount="4">
                                                <Items>
                                                    ...
                                                    <dx:LayoutItem Caption="Date" FieldName="TransDate" ColSpan="2">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxDateEdit ID="dtTransDate" ClientInstanceName="dtTransDate" ClientEnabled="false" runat="server" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"></dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    ...
                                                    <dx:LayoutItem Caption="Start Date" FieldName="StartDate" ColSpan="2">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxDateEdit ID="dtStartDate" ClientInstanceName="dtStartDate" ClientEnabled="false" runat="server" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"></dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="End Date" FieldName="EndDate" ColSpan="2">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxDateEdit ID="dtEndDate" ClientInstanceName="dtEndDate" ClientEnabled="false" runat="server" DisplayFormatString="dd-MM-yyyy" EditFormatString="dd-MM-yyyy"></dx:ASPxDateEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    ...
                                                    <dx:LayoutItem Caption="Regular Working Hours" FieldName="RegularWorkHrs" ColSpan="2">
                                                     ...
                                                     AllowMouseWheel="false" NumberType="Integer"  ClientInstanceName="txtRegularWorkHrs" runat="server" ClientEnabled="false"></dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Ramadan Working Hours" FieldName="RamadanWorkHrs" ColSpan="2">
                                                     ...
                                                     AllowMouseWheel="false" NumberType="Integer"   ClientInstanceName="txtRamadanWorkHrs" runat="server" ClientEnabled="false"></dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    ...
                                                    <dx:LayoutItem Caption="Monthly Rate" FieldName="MonthlyRate" ColSpan="2">
                                                     ...
                                                     AllowMouseWheel="false" NumberType="Integer"    ClientInstanceName="txtMonthlyRate" runat="server" ClientEnabled="false"></dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    <dx:LayoutItem Caption="Unit Of Addition" FieldName="UnitOfAddition" ColSpan="2">
                                                        <LayoutItemNestedControlCollection>
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxTextBox ID="txtUnitOfAddition" ClientInstanceName="txtUnitOfAddition" runat="server" ClientEnabled="false"></dx:ASPxTextBox>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                    ...
                                                    <dx:LayoutItem Caption="Extra Working Hour Rate" FieldName="ExtraWorkHourRate" ColSpan="2">
                                                     ...
                                                     AllowMouseWheel="false" NumberType="Integer"  ClientInstanceName="txtExtraWorkHourRate" runat="server" ClientEnabled="false"></dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
                                                    </dx:LayoutItem>
                                                            ...
                                                            <dx:LayoutItemNestedControlContainer>
                                                                <dx:ASPxGridView runat="server" ID="GdvWorkOrderList" AutoGenerateColumns="false" ClientInstanceName="gridWorkOrderList"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <dx:GridViewDataDateColumn FieldName="StartDate" Caption="Start Date" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                                                        </dx:GridViewDataDateColumn>
                                                                        <dx:GridViewDataDateColumn FieldName="EndDate" Caption="End Date" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                                                        </dx:GridViewDataDateColumn>
                                                                        <dx:GridViewDataTextColumn FieldName="SiteName" Caption="Site Name" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                                                        </dx:GridViewDataTextColumn>
                                                                        <dx:GridViewDataComboBoxColumn FieldName="ShiftStatus" Caption="Shift Status" VisibleIndex="1">
                                                                            ...
                                                                            <HeaderCaptionTemplate>
                                                                                <dx:ASPxButton AutoPostBack="false" ID="btnAddNew" CssClass="btn btn-mini btn-sm btn-round btn-primary" runat="server">
                                                                                    <ClientSideEvents Init="function(s, e) {s.GetTextContainer().className = ' fa fa-plus';}"
                                                                                        Click="function (s, e) { SetWorkorderControls(true);sid.SetValue(0);ASPxClientEdit.ClearEditorsInContainerById('contentDiv'); }" />
                                                                                    <BackgroundImage HorizontalPosition="center" />
                                                                                </dx:ASPxButton>
                                                                            </HeaderCaptionTemplate>
                                                                            <CustomButtons>
