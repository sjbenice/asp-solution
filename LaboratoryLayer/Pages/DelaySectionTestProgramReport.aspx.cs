...
{
    public class DelaySectionTestProgramReport : Page
    {
        ...
        protected XtraReport GetReport()
        {
            try
            {
                LaboratoryLayer.Reports.Menu.DelaySectionTestProgram rptLateSampleReport = new LaboratoryLayer.Reports.Menu.DelaySectionTestProgram();                // LaboratoryLayer.Reports.LateSampleReport rptLateSampleReport = new LaboratoryLayer.Reports.LateSampleReport();
                if (dtDateFrom.Text != "")
                ...
                if (ASPxDropDownEdit1.Value != null)
                    rptLateSampleReport.Parameters["LabSection"].Value = ASPxDropDownEdit1.Value;
                else
                    rptLateSampleReport.Parameters["LabSection"].Value = "";
