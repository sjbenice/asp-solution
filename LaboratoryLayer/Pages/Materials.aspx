<%@ Page Language="C#" AutoEventWireup="True" MasterPageFile="~/Main.Master" CodeBehind="Materials.aspx.cs" Inherits="LaboratoryLayer.Pages.Materials" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <dx:ASPxGridView runat="server" ID="GdvMaterialTestList" AutoGenerateColumns="false" ClientInstanceName="gridMaterialTestList"
                                        ...
                                        <Columns>
                                            <dx:GridViewDataComboBoxColumn FieldName="FKGroupID" Caption="Group Report" Width="230" VisibleIndex="1">
                                                <PropertiesComboBox ValueField="GroupID" TextField="GroupName" DataSourceID="ReportGroupDS" ValueType="System.Int32">
                                                </PropertiesComboBox>
                    ...
                    <dx:ASPxGridView runat="server" ID="GdvLabTestsList" AutoGenerateColumns="false" Width="100%" ClientInstanceName="gridLabTestsList"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="AshghalTestNumber" Caption="Ashghal Test Number" VisibleIndex="4" CellStyle-HorizontalAlign="Left">
                                <Settings  AutoFilterCondition="Contains"/> </dx:GridViewDataTextColumn>
                            <dx:GridViewDataComboBoxColumn FieldName="FkGroupId" Caption="Group Report" Width="230" VisibleIndex="5">
                                <PropertiesComboBox ValueField="GroupID" TextField="GroupName" DataSourceID="ReportGroupByMaterialTypeDS" ValueType="System.Int32">
                                </PropertiesComboBox>                                
                            </dx:GridViewDataComboBoxColumn>
                            <dx:GridViewCommandColumn VisibleIndex="6" ButtonType="Default" Width="60" ShowClearFilterButton="true" ShowSelectCheckbox="true">
                            </dx:GridViewCommandColumn>
                        </Columns>
                        <SettingsCommandButton>
                            <ClearFilterButton Text=" " Styles-Style-Font-Size="Medium" Styles-Style-CssClass="fa fa-eraser" />
    ...
    <asp:ObjectDataSource ID="TestsListDS" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="BusinessLayer.Pages.TestsListDB"
        SelectMethod="GetAllWithoutGroup" DataObjectTypeName="BusinessLayer.TestsList" UpdateMethod="UpdateToSession">
         <SelectParameters>
            <asp:SessionParameter SessionField="FKMaterialDetailsID" Name="FKMaterialDetailsID" Type="Int32"></asp:SessionParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource ID="ReportGroupByMaterialTypeDS" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="BusinessLayer.Pages.ReportGroupDB"
        SelectMethod="GetByMaterialTypeID" DataObjectTypeName="BusinessLayer.ReportGroup">
        <SelectParameters>
