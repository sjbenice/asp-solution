<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="LabTestInfoManage.aspx.cs" Inherits="LaboratoryLayer.Pages.LabTestInfoManage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function PrintServiceInfo(testID) {
            window.open('ReportViwer.aspx?source=ServiceInformation&id=' + testID);
        }
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="btn-toolbar">
            ...
            <Columns>
                ...
                <dx:GridViewDataColumn Name="Edit" VisibleIndex="8" Width="25">
                    <DataItemTemplate>
                        ...
                        <a href="javascript:void(0)" onclick="OnMoreInfoClick('LastTestInfoAttachment.aspx?id='+ <%#Eval("TestID") %>);">
                ...
                <dx:GridViewDataColumn Name="Edit" VisibleIndex="9" Width="25">
                    <DataItemTemplate>
                         <a href="javascript:void(0)" style="display:block; text-wrap:avoid; width: 100px" onclick='return PrintServiceInfo(<%#Eval("TestID") %>);'>
        ...
        <div>
         <dx:ASPxPopupControl ID="popupControl" runat="server" ClientInstanceName="clientPopupControl" CloseAction="CloseButton" Height="500px" Modal="True" Width="900px" 
                              PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" HeaderText="Attached Files"
