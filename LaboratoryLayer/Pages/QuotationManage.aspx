<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="QuotationManage.aspx.cs" Inherits="LaboratoryLayer.Pages.QuotationManage" %>
  ...
  <Header BackColor="SteelBlue" ForeColor="White"></Header>
    ...
    <div class="btn-toolbar">
        <dx:ASPxGridView runat="server" ID="GdvQuotationHistory" AutoGenerateColumns="false" Width="100%" ClientInstanceName="gridQuotationHistory" OnRowCommand="GdvQuotationHistory_RowCommand"
            KeyFieldName="QuotationMasterID" EnableRowsCache="False" >
                            ...
                            <DataItemTemplate>
                                <table cellpadding="0" cellspacing="2">
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxButton ID="btnRevise2"  runat="server" ToolTip="Revise" Cursor="pointer" Width="18px" Enabled='<%#Convert.ToBoolean(Eval("EditQuotation"))%>'
