<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="ActiveWorkOrdersReport.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.ActiveWorkOrdersReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagePath" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb" runat="server" id="ultitle">
            ...
            <li class="active" id="menulink">Active Work Orders</li>
        </ul>
    </div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
                 ...
                 <table>
                    <tr>
                         ...
                         <td style="width: 20px; text-align: right;">
                            <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="WO#" CssClass="lable"></dx:ASPxLabel>  
                        </td>
                        <td>
                            <dx:ASPxComboBox ID="cmbWorkOrderNo" runat="server" ValueField="WorkOrderNo" TextField="WorkOrderNo" DropDownStyle="DropDownList" Width="170"
                                    DataSourceID="WorkOrderNoDS" ValueType="System.String" ClientInstanceName="cmbWorkOrderNo">
                                    <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                </ValidationSettings>
                            </dx:ASPxComboBox> </td>
                        <td>
                            <dx:ASPxButton ID="btnWorkOrderNo" runat="server" Text="X" AutoPostBack="False" ToolTip="Clear Work Order #" Width="20px">  
                                <ClientSideEvents Click="function(s, e) { cmbWorkOrderNo.SetValue(null); }" />  
                            </dx:ASPxButton>
                        </td>
                        <td style="width: 130px; text-align: right;">
                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Wo Date" CssClass="lable"></dx:ASPxLabel>
                        </td>
                        <td style="width: 200px">
                            <dx:ASPxDateEdit ID="dtTransDate" runat="server" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy">
                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                    ...
                    <tr>
                        ...
                        <td style="width: 200px">
                            <dx:ASPxDateEdit ID="dtLastInvoicePaidDate" runat="server" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy">
                                <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                  <%--  <RequiredField IsRequired="true" ErrorText="!" />--%>
                                </ValidationSettings>                                                            
                            </dx:ASPxDateEdit>
                        ...
                        <td style="width: 200px">
                          ...
                          <td style="width: 10px"> <dx:ASPxTextBox ID="dtLastInvoicePaidAmount" runat="server">
                            </dx:ASPxTextBox></td>
                        <td>
    ...
    <dx:ASPxDocumentViewer ID="ReportViewer1" runat="server" BackColor="Transparent" Height="800px" Width="100%" ZoomMode="Percent" ZoomPercent="100" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" ProcessingMode="Remote" ShowParameterPrompts="False" SettingsSplitter-SidePaneVisible="false" ToolBarItemBorderStyle="Solid">
      ...
      <asp:ObjectDataSource ID="WorkOrderNoDS" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="BusinessLayer.Pages.WorkOrderListDB"
