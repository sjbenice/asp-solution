<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttachmentsReport.aspx.cs" Inherits="LaboratoryLayer.Pages.AttachmentsReport" %>
...
<%--            <link href="../MasterPages/Test/css/style.default.css" rel="stylesheet" />--%>
            ...
            <div style="width: 100%; height: inherit">
                ...
                <div id="table1" runat="server" class="table" style="padding-left: 10px; padding-right: 10px; padding-top: 10px">
                    <div class="divrow">
                        <div>
                        ...
                        <div style="float: left; margin-right: 80px;">
                            <dx:ASPxUploadControl ID="UploadControl" runat="server" ClientInstanceName="UploadControl" Width="320"
                                ...
                                <ValidationSettings
                                    AllowedFileExtensions=".*" MaxFileSize="104857600">
                                </ValidationSettings>
                            ...
                            <br />
                            <p class="note">
                                <dx:ASPxLabel ID="AllowedFileExtensionsLabel" runat="server" Text="Allowed file extensions: .*" Font-Size="8pt">
                                </dx:ASPxLabel>
                                <br />
                                <dx:ASPxLabel ID="MaxFileSizeLabel" runat="server" Text="Maximum file size: 100 MB." Font-Size="8pt">
                                </dx:ASPxLabel>
                            </p>
                        </div>
                    </div>
                            ...
                            <PanelCollection>
                                <dx:PanelContent>
                                    <dx:ASPxGridView ID="gdvfiles" ClientInstanceName="gdvfiles" runat="server" DataSourceID="TransactionAttachmentsDS" KeyFieldName="FileID" Width="380" OnCustomCallback="gdvfiles_CustomCallback"  OnRowCommand="gdvfiles_RowCommand">
                                        <Columns>
                                            <dx:GridViewDataHyperLinkColumn FieldName="FileName" Caption="File" Width="250" VisibleIndex="1">
                                                <DataItemTemplate>
                                                    <a target='blank' style="display: block; text-wrap: avoid; width: 100px"
                                                          onclick='<%# "return ChangeLink(\"" + HttpUtility.UrlEncode(Eval("FileUrl").ToString()) +  "\")" %>' ><%#Eval("FileName") %></a>
                                                </DataItemTemplate>
                                            </dx:GridViewDataHyperLinkColumn>
                                            <dx:GridViewDataTextColumn FieldName="FileSize" Name="filesize" Caption="Size" Width="50" VisibleIndex="2"><Settings  AutoFilterCondition="Contains"/> </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn FieldName="CreatedDate" Visible="false" Name="createdDate" Caption="Created Date" Width="200" VisibleIndex="3"><Settings  AutoFilterCondition="Contains"/> </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataColumn Name="Delete" Width="30" VisibleIndex="5">
                                                <DataItemTemplate>
                                            ...
                                            <dx:GridViewDataColumn Name="Edit" Width="25" VisibleIndex="4">
                                                <DataItemTemplate>
