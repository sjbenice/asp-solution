...
namespace LaboratoryLayer.Pages.Reports
{
	public class ServicesVsConsumableMaterialsReport : Page
	{
		...
		protected void btnGenerate_Click(object sender, EventArgs e)
		{
            ...
            //this.ReportViewer1.Report = this.GetReport();
            else if (this.ReportViewer1.Report == null || this.ReportViewer1.Report.RowCount == 0)
            {
                this.ReportViewer1.Visible = false;
		...
		{
            LaboratoryLayer.Reports.Menu.ServicesVsConsumableMaterialsReport servicesVsConsumableMaterials = new LaboratoryLayer.Reports.Menu.ServicesVsConsumableMaterialsReport();
            if (dtDateFrom.Text != "")
