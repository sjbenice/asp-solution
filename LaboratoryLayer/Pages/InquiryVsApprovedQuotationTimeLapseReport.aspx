<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="InquiryVsApprovedQuotationTimeLapseReport.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.InquiryVsApprovedQuotationTimeLapseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagePath" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb" runat="server" id="ultitle">
            ...
            <li class="active" id="menulink">Inquiry Vs Approved Quotation Time Lapse</li>
        </ul>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageHeader" runat="server">
    <div class="page-header">
        <h1>Inquiry Vs Approved Quotation Time Lapse</h1>
    </div>
</asp:Content>
