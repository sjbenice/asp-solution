<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="AdvancePaymentsBalancesReport.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.AdvancePaymentsBalancesReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagePath" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb" runat="server" id="ultitle">
            ...
            <li class="active" id="menulink">Advance Payments Balances</li>
        </ul>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageHeader" runat="server">
    <div class="page-header">
        <h1>Advance Payments Balances</h1>
    </div>
</asp:Content>
        ...
        <div style="width: 1000px; float: left; position: relative; padding-left: 10px">
            ...
            <div id="divValidityDetails" runat="server" style="clear: left; ">
                <table>
                    <tr>
                        <td style="width: 75px">
                            <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text="Ziro Balance" CssClass="lable"></dx:ASPxLabel>
                        </td>
                        <td style="width: 50px">
                            <dx:ASPxCheckBox ID="cbZeroBalance" runat="server">
                            </dx:ASPxCheckBox>
