<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="PriceUnit.aspx.cs" Inherits="LaboratoryLayer.Pages.PriceUnit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagePath" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb" runat="server" id="ultitle">
            ...
            <li class="active" id="menulink">Price Units</li>
        </ul>
    </div>
</asp:Content>
