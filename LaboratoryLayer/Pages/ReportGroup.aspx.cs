...
namespace LaboratoryLayer.Pages
{
	...
	public class ReportGroup : Page
	{
        ...
        {
            base.Response.Redirect("ReportGroupInfo.aspx");
        }
		...
		protected void GdvServiceGroupList_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
		{
			ASPxWebControl.RedirectOnCallback("ReportGroupInfo.aspx?id=" + e.KeyValue.ToString());
		}
