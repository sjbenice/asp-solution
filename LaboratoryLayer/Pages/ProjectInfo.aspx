<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="ProjectInfo.aspx.cs" Inherits="LaboratoryLayer.Pages.ProjectInfo" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group" role="group" aria-label="First group">
            ...
            <dx:ASPxButton ID="btnUpload" ClientInstanceName="btnUpload"  CssClass="btn btn-round btn-primary glyphicon glyphicon-floppy-disk" 
