<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="SampleReceive.aspx.cs" Inherits="LaboratoryLayer.Pages.SampleReceive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function OnMoreInfoClick() {
            ...
            var contentUrl = 'SampleReceiveReportVersion.aspx?id=' + id ;
    ...
    <script type="text/javascript">
        ...
        function grid_SelectionChanged(s, e) {   
            ...
            if (selectedKeys == "")
            {
                cmbFKMaterialTypeID.SetEnabled(true);
                cmbFKMaterialDetailsID.SetEnabled(true);
            }
    ...
    <script type="text/javascript">
       ...
       function getValueOfCell(rowVisibleIndex, columnName) {
           return new Promise(function (resolve, reject) {
               var gridView = ASPxClientGridView.Cast("gdvCustomFields");

               gridView.GetRowValues(rowVisibleIndex, [columnName], function (values) {
                   var cellValue = null;
                   if (values && values.length > 0) {
                       cellValue = values[0];
                   }
                   // Resolve the Promise with the retrieved cell value
                   resolve(cellValue);
               });
           });
       }
       var isRequiredValue = false;
       function getRowValuesAsync(gridView, rowIndex, columnIndex) {
           return new Promise((resolve, reject) => {
               // Specify the callback function to handle the retrieved row values
               function GridOnGetRowValues(values) {
                   // Resolve the promise with the retrieved row values
                   resolve(values);
               }

               // Retrieve row values asynchronously and specify the callback function
               gridView.GetRowValues(rowIndex, columnIndex, GridOnGetRowValues);
           });
       }
        ...
        function onSaveClick(s, e) {
           ...
           var gridView = ASPxClientGridView.Cast("gdvCustomFields");
           var indiciesgridView = gridView.batchEditHelper.GetDataItemVisibleIndices();
           for (var i = 0; i < indiciesgridView.length; i++) {
               debugger;
                
               isRequiredValue = gridView.batchEditApi.GetCellValue(indiciesgridView[i], "FkCustomFieldID");

               var row = gridView.GetRow(i);
               isRequiredValue = row.cells[2].textContent.trim();
               var fieldNameValue = gridView.batchEditApi.GetCellValue(indiciesgridView[i], "Value");
               if (isRequiredValue === "True" && (fieldNameValue === null || fieldNameValue === "")) {
                   isValidGrid = false;
                   break;
               }
           }
           ...
           var inactiveVal = document.getElementById('body_flSampleReceiveList_ASPxTextBox1_I').value;
           if (inactiveVal == 'True') {
               lblErrorMessage.SetText("");
               var errorDiv = document.getElementById('divError');
               errorDiv.style.display = 'block';
               errorDiv.className = 'alert alert-danger';
               lblErrorMessage.SetText(" Project of the JO is INACTIVE.");
               isValidGrid = false;
           }
           //else {
           //    var errorDiv = document.getElementById('divError');
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">   
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
        ...
        <div class="btn-group" role="group" aria-label="First group">
            <dx:ASPxButton AutoPostBack="false" ID="btnReports" Text="Reports" CssClass="btn btn-round btn-primary fa fa-print" runat="server">
                <ClientSideEvents click="OnMoreInfoClick"/>
                        ...
                        <dx:LayoutItem Caption="Sample Number" FieldName="SampleNo" ColSpan="2" CaptionStyle-Font-Bold="true" HorizontalAlign="Right">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox ID="txtSampleNo" Width="100" HorizontalAlign="Center" CaptionStyle-Font-Bold="true" Font-Bold="true" runat="server" ReadOnly="true">
...
<%--                                    <dx:ASPxDateEdit ID="dtReceiveDate" runat="server" DisplayFormatString="dd MMM yyyy" EditFormatString="dd MMM yyyy"></dx:ASPxDateEdit>--%>
                            <dx:ASPxDateEdit ID="dtReceiveDate" runat="server" DisplayFormatString="dd MMM yyyy HH:mm" EditFormatString="dd MMM yyyy HH:mm">
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbFKJobOrderMasterID" runat="server" ValueField="JobOrderMasterID" DataSourceID="JobOrderMasterDS" ValueType="System.Int64" Width="250px"
                                        AutoPostBack="true" TextFormatString="{0} - ({2:dd MMM yyyy}) - {1} - {3} - {4}" DropDownStyle="DropDownList" OnSelectedIndexChanged="cmbFKJobOrderMasterID_SelectedIndexChanged">
...
<DropDownButton ClientVisible="False"></DropDownButton>
            ...
            <%--Added by Barkat--%>
            <dx:LayoutItem Caption="gfh" FieldName="Project
                              IsActive" ColSpan="2" ClientVisible="false">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer>
                ...
                <dx:LayoutGroup Caption="Sample Details" ColCount="6" ColSpan="2">
                    <Items>
                        ...
                        <dx:LayoutItem Caption="Sample Transported By" FieldName="SampleBroughtInBy" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox ID="txtSampleBroughtInBy" runat="server"></dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                         <dx:LayoutItem Caption="Sample Location Indicated By" FieldName="SampleLocationIndicatedBy" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox ID="txtSampleLocationIndicatedBy" runat="server"></dx:ASPxTextBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                ...
                <dx:LayoutGroup Caption="Other Details" ColCount="6" ColSpan="2">
                    <Items>
                        <dx:LayoutItem Caption="Service Section" FieldName="FKMaterialTypeID" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbFKMaterialTypeID" ClientInstanceName="cmbFKMaterialTypeID" runat="server" Width="250" ValueField="MaterialTypeID" TextField="MaterialName"
                        ...
                        <dx:LayoutItem Caption="Material Details" FieldName="FKMaterialDetailsID" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxComboBox ID="cmbFKMaterialDetailsID" ClientInstanceName="cmbFKMaterialDetailsID" runat="server" Width="200" ValueField="MaterialDetailsID" TextField="MaterialName"
                ...
                <dx:LayoutGroup Caption="Additional Sample Information" Width="25%">
                    <Items>
                        <dx:LayoutItem ShowCaption="False">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxGridView runat="server" ID="gdvCustomFields" OnRowUpdating="gdvCustomFields_RowUpdating" AutoGenerateColumns="false"
                                         ClientInstanceName="gdvCustomFields"
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
                                        ...
                                        <Columns>
                                            <dx:GridViewDataComboBoxColumn Name="FkCustomFieldID" FieldName="FkCustomFieldID" Caption="Field Name" VisibleIndex="0">
                                            ...
                                            <dx:GridViewDataTextColumn  FieldName="Value" Caption="Value" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                                <Settings AutoFilterCondition="Contains" />

<CellStyle HorizontalAlign="Left"></CellStyle>
                                            </dx:GridViewDataTextColumn>

                                            <dx:GridViewDataComboBoxColumn Name="FkCustomFieldID1" FieldName="FkCustomFieldID" Caption="IsRequired" VisibleIndex="2">
                                                <PropertiesComboBox ValueField="CustomFieldID" TextField="IsRequired" DataSourceID="MaterialTypesCustomFieldsDS" DropDownRows="1">
                                                    <DropDownButton ClientVisible="false"></DropDownButton>
                                                </PropertiesComboBox>
                                                <EditFormSettings Visible="False" />
                                                <Settings AutoFilterCondition="Contains" />
                        ...
                        <dx:LayoutItem ShowCaption="False">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    ...
                                    <dx:ASPxGridView runat="server" ID="gdvSampleTestList" AutoGenerateColumns="false" ClientInstanceName="gdvSampleTestList" 
                                        OnCustomJSProperties="gdvSampleTestList_CustomJSProperties" OnCommandButtonInitialize="gdvSampleTestList_CommandButtonInitialize"
                                        DataSourceID="SampleReceiveTestListDS" KeyFieldName="SampleReceiveTestID" Width="100%" 
                                        OnRowUpdating="gdvSampleTestList_RowUpdating" 
                                        OnCellEditorInitialize="gdvSampleTestList_CellEditorInitialize" OnRowValidating="gdvSampleTestList_RowValidating"
                                         OnCustomCallback="gdvSampleTestList_CustomCallback" OnHtmlDataCellPrepared="gdvSampleTestList_HtmlDataCellPrepared">
                                        <ClientSideEvents SelectionChanged="grid_SelectionChanged" />
                                        <Columns>
                                            <dx:GridViewCommandColumn Name="Check" VisibleIndex="0" ButtonType="Default" Width="30" ShowSelectCheckbox="true">
                                            </dx:GridViewCommandColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="FKGroupID" Name="FKGroupID" Caption="Group Service" VisibleIndex="1" ReadOnly="true" Width="150">
                                                <PropertiesComboBox ValueField="GroupID" TextField="GroupName" DataSourceID="ReportGroupDS" DropDownRows="1">
                                                    
                                                    <Style CssClass="ComboBoxSize"></Style>
                                                </PropertiesComboBox>
                                                <Settings AutoFilterCondition="Contains" />
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataCheckColumn Name="Enabled" VisibleIndex="2" FieldName="IsEnabled" Width="0">
                                            </dx:GridViewDataCheckColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="FKTestID" Name="FKTestID" Caption="Services Name" VisibleIndex="3" ReadOnly="true" Width="150">
                                            ...
                                            <dx:GridViewDataComboBoxColumn FieldName="FKTestID" Caption="Std No" VisibleIndex="4" ReadOnly="true">
                                            ...
                                            <dx:GridViewDataComboBoxColumn FieldName="Witness" Name="Witness" Caption="Witness" VisibleIndex="5">
                                            ...
                                            <dx:GridViewDataTextColumn FieldName="WitnessName" Name="WitnessName" Caption="Wtns. Name" VisibleIndex="6">
                                                <Settings AutoFilterCondition="Contains" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="Subcontract" Name="Subcontract" Caption="Sub Contracted" VisibleIndex="7">
                                                <PropertiesComboBox ValueType="System.Boolean">
                                                    <Items>
                                                        <dx:ListEditItem Text="Yes" Value="true" />
                                                        <dx:ListEditItem Text="No" Value="false" />
                                            ...
                                            <dx:GridViewDataComboBoxColumn FieldName="FKSubContractorID" Caption="Sub Cont. Name" VisibleIndex="8">
                                            ...
                                            <dx:GridViewDataComboBoxColumn FieldName="FKPriceUnitID" Caption="Unit" VisibleIndex="9" ReadOnly="true">
                                            ...
                                            <dx:GridViewDataSpinEditColumn FieldName="Price" Caption="Price" VisibleIndex="10" Visible="false">
                                                <PropertiesSpinEdit SpinButtons-ShowIncrementButtons="false" DisplayFormatString="n2"
                                                    AllowMouseWheel="false">
<SpinButtons ShowIncrementButtons="False"></SpinButtons>

                                                    <ValidationSettings ValidationGroup="editForm" ErrorDisplayMode="ImageWithTooltip" RequiredField-IsRequired="true" ErrorText="Price is missing!">
<RequiredField IsRequired="True"></RequiredField>
                                                    </ValidationSettings>
                                                </PropertiesSpinEdit>
                                            </dx:GridViewDataSpinEditColumn>

                                            <dx:GridViewDataTextColumn  FieldName="MinQty" Name="MinQty" Caption="Min Qty" VisibleIndex="11" ReadOnly="true">
                                                <PropertiesTextEdit NullDisplayText="" DisplayFormatString="n0" />
                                            </dx:GridViewDataTextColumn>

                                            <dx:GridViewDataSpinEditColumn FieldName="Qty" Name="Qty" Caption="Qty" VisibleIndex="12">
                                                <PropertiesSpinEdit SpinButtons-ShowIncrementButtons="false" NumberType="Float" DisplayFormatString="N2"
                                                    AllowMouseWheel="false">
...
<SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                            ...
                                            <dx:GridViewDataSpinEditColumn FieldName="Price" Name="Price" Caption="Price" VisibleIndex="13" Width="0">
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dx:GridViewDataSpinEditColumn>
                                            <dx:GridViewDataTextColumn FieldName="Remarks" Caption="Remarks" VisibleIndex="14">
                                                <Settings AutoFilterCondition="Contains" />
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewCommandColumn VisibleIndex="15" ButtonType="Default" ShowEditButton="false" ShowDeleteButton="false" ShowCancelButton="false" ShowUpdateButton="false" Width="0">
...
<div>
    ...
    <asp:ObjectDataSource ID="SampledDS" runat="server" TypeName="LaboratoryLayer.Pages.SampleReceive" SelectMethod="GetSampledList"></asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource ID="MaterialsTypesDS" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="BusinessLayer.Pages.MaterialsTypesDB"
        SelectMethod="GetActiveOnly" DataObjectTypeName="BusinessLayer.MaterialsTypes"></asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource ID="SampleReceiveMaterialCustomFieldDS" runat="server" OldValuesParameterFormatString="original_{0}" DataObjectTypeName="BusinessLayer.SampleReceiveMaterialCustomField" TypeName="BusinessLayer.Pages.SampleReceiveMaterialCustomFieldDB"
        SelectMethod="GetNonTableFieldsByFKMaterialTypeIDWithSession" UpdateMethod="UpdateSampleMaterialCustomFieldWithSession">
        <SelectParameters>
            <asp:ControlParameter ControlID="ctl00$body$flSampleReceiveList$cmbFKMaterialTypeID" PropertyName="Value" DefaultValue="0" Name="FKMaterialTypeID" Type="Int32" />
    ...
    <asp:ObjectDataSource ID="ReportGroupDS" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="BusinessLayer.Pages.ReportGroupDB"
        SelectMethod="GetAll" DataObjectTypeName="BusinessLayer.ReportGroup">
    </asp:ObjectDataSource>
</asp:Content>