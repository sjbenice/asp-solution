...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <div style="position: relative; width: auto; background-repeat: repeat" id="divParms" runat="server">
        <div style="width: 100%; float: left; position: relative; padding-left: 10px">
            ...
            <div id="divValidityDetails" runat="server" style="clear: left; ">
                <table style="width:100%">
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="ddlTestAvailability" runat="server" ValueType="System.String" DisplayFormatString="{0}" 
                                ClientInstanceName="ddlTestAvailability" SelectedIndex="0"
                                CssClass="textbox" AutoGenerateColumns="False" DropDownStyle="DropDownList"  
                                
                                IncrementalFilteringMode="Contains" ClientEnabled="true"  EnableCallbackMode="true" Width="200">
                                <Items>
                                         <dx:ListEditItem  Text="" Value="0" />
                                    <dx:ListEditItem  Text="Test not available" Value="1" />
                                    <dx:ListEditItem Text="Service to be subcontracted" Value="2"/>
                                    <dx:ListEditItem Text="Site Test" Value="3"/>
                                    <dx:ListEditItem Text="Inactive" Value="4"/>
                        ...
                        <td>
                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="X" AutoPostBack="False" ToolTip="Clear Lab Section">  
                                <ClientSideEvents Click="function(s, e) {  ddlTestAvailability.SetValue(null); }" />  
                            </dx:ASPxButton>  
                        </td>
