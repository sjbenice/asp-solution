<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="DateVsPaymentReport.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.DateVsPaymentReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PagePath" runat="server">
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb" runat="server" id="ultitle">
            ...
            <li class="active" id="menulink">Invoice Vs Date</li>
        </ul>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="PageHeader" runat="server">
    <div class="page-header">
        <h1>Invoice Vs Date</h1>
    </div>
</asp:Content>
                 ...
                 <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 200px">
                         ...
                         <td style="width: 120px">
                            <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Receipt No" CssClass="lable"></dx:ASPxLabel>  
                        </td>
                        <td style="width: 200px">
                            <dx:ASPxTextBox ID="tbReceiptNo" runat="server">
                            </dx:ASPxTextBox>
                        </td>
                        <td style="width: 130px">
                            <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Book CRV No" CssClass="lable"></dx:ASPxLabel>  
                        </td>
                        <td style="width: 200px">
                            <dx:ASPxTextBox ID="txtBookCrvNo" runat="server">
                            </dx:ASPxTextBox>
                        </td>
                     ...
                     <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="cmbCustomer" runat="server" ValueField="CustomerID" TextField="CustomerName" DropDownStyle="DropDownList" Width="200"
