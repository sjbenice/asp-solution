<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="ValidityDetails.aspx.cs" Inherits="LaboratoryLayer.Pages.ValidityDetails" %>
                    ...
                    <div class="btn-toolbar">
                        <dx:ASPxGridView runat="server" ID="GdvValidityListDetails" AutoGenerateColumns="false" Width="100%" ClientInstanceName="gridValidityListDetails" DataSourceID="ValidityListDetailsDS" KeyFieldName="ValidityDetailsID"
                            ...
                            <Columns>
                                ...
                                <Settings  AutoFilterCondition="Contains"/> </dx:GridViewDataTextColumn>
                                  <dx:GridViewDataHyperLinkColumn FieldName="CertificateSerialNumber" Caption="Certificate Serial Number" VisibleIndex="2" CellStyle-HorizontalAlign="Left">
                                    <Settings  AutoFilterCondition="Contains"/> 
                                      <DataItemTemplate>
                                        <a target='blank' style="display: block; padding-left: 2px; text-wrap: avoid; width: 30px" onclick='return ShowAttachmentWindow(event, this);' href="../Pages/Attachments.aspx?TransTypeID=44444&TransID=<%# Eval("CertificateSerialNumber") %>" title="Attachments"><%# Eval("CertificateSerialNumber") %></a>
                                    </DataItemTemplate>
                                ...
                                <dx:GridViewDataTextColumn FieldName="CalibratedBy" Caption="Calibrated By" VisibleIndex="7" CellStyle-HorizontalAlign="Left">
                                 ...
                                 <dx:GridViewDataTextColumn FieldName="NotInUsed" Caption="NotInUsed" VisibleIndex="9" CellStyle-HorizontalAlign="Left">
                                </dx:GridViewDataTextColumn>
                                    ...
                                    <asp:Panel ID="PanEditForm" runat="server">
                                        ...
                                        <tr style="height: 3px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dx:ASPxDateEdit ID="dtExpiryDate" DisplayFormatString="dd MMM yyyy" EditFormatString="dd MMM yyyy" runat="server" Value='<%#Eval("ExpiryDate") %>'>
                                                          <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    <dx:ASPxMemo ID="txtRemarks" runat="server" Width="300" Height="40" Text='<%#Eval("Remarks") %>'></dx:ASPxMemo>
                                                </td>

                                                <td>
                                                    <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Not In Used"></dx:ASPxLabel>
                                                </td>
                                                <td colspan="3">
                                                    <dx:ASPxCheckBox ID="chkNotInUsed" Checked='<%# Eval("NotInUsed") != DBNull.Value ? Convert.ToBoolean(Eval("NotInUsed")) : false %>' runat="server"></dx:ASPxCheckBox>
                                                </td>
