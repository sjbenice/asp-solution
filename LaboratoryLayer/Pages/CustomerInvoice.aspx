<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="CustomerInvoice.aspx.cs" Inherits="LaboratoryLayer.Pages.CustomerInvoice" %>
                        ...
                        <dx:LayoutItem ShowCaption="False" ColSpan="8">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    ...
                                    <dx:ASPxGridView runat="server" ID="GdvSampleReceiveTests" AutoGenerateColumns="false" Width="100%" 
                                        ClientInstanceName="gridSampleReceiveTests"  OnBatchUpdate="GdvSampleReceiveTests_BatchUpdate"
