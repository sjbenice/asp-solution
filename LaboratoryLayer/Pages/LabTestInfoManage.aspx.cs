...
namespace LaboratoryLayer.Pages
{
	...
	public class LabTestInfoManage : Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
            ...
            //Barkat  : To maintain filter expression selected while search   07/11/2023
            if (!IsPostBack)
            {
                if (Session["FilterExpression"] != null)
                {
                    string filterExpression = Session["FilterExpression"].ToString();
                    this.GdvLabTestsList.FilterExpression = filterExpression;
                }
            }
		...
		protected void GdvLabTestsList_BeforeGetCallbackResult(object sender, EventArgs e)
		{
            ...
            // Barkat : Implemented to Hold the Search Values  07/11/2023
            Session["FilterExpression"] = this.GdvLabTestsList.FilterExpression;
        }
