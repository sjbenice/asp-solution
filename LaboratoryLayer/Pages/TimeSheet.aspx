<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="TimeSheet.aspx.cs" Inherits="LaboratoryLayer.Pages.TimeSheet" %>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxDateEdit ID="dtTodate" Width="150" runat="server" CssClass="textbox" DisplayFormatString="dd MMM yyyy " EditFormatString="dd MMM yyyy">
                                    <ValidationSettings ValidateOnLeave="true" ValidationGroup="savegrp">
                                        <RequiredField IsRequired="true" ErrorText="Enter Date" />
                                    </ValidationSettings>
                                </dx:ASPxDateEdit>
