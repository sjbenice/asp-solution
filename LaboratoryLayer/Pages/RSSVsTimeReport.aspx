<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="RSSVsTimeReport.aspx.cs" Inherits="LaboratoryLayer.Pages.Reports.RSSVsTimeReport" %>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                         ...
                         <td style="width: 20px">
                            <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="Technician Name#" CssClass="lable"></dx:ASPxLabel>  
                        </td>
                        <td>
                           <dx:ASPxComboBox ID="CmbTechnician"  Width="200px" ClientInstanceName="CmbTechnician" DataSourceID="EmpListDS"  CssClass="textbox" 
                               AutoPostBack="false" runat="server" IncrementalFilteringMode="Contains" TextFormatString="{0} -{1}" ValueType="System.Int64" ValueField="EmpID" 
                               TextField="EmpName">
                                    <ValidationSettings ValidateOnLeave="true" ValidationGroup="editForm" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                      </ValidationSettings>
                                </dx:ASPxComboBox>
                        ...
                        <td>
                            <dx:ASPxButton ID="btnCmbTechnician" runat="server" Text="X" AutoPostBack="False" ToolTip="Clear Technician Name #">  
                                <ClientSideEvents Click="function(s, e) { CmbTechnician.SetValue(null); }" />  
                            </dx:ASPxButton>  
                        </td>
