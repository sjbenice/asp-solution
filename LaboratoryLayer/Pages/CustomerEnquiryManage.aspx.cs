...
namespace LaboratoryLayer.Pages
{
	...
	public class CustomerEnquiryManage : Page
	{
		...
		protected void GdvCustomerEnquiry_CustomButtonInitialize(object sender, ASPxGridViewCustomButtonEventArgs e)
		{
			...
			if (roleLinks.Any(c => c.LinksEName == "Copy of Customer Enquiry" &&c.OptionEName=="Add"))
			{
			...
			else if (!roleLinks.Any(c => c.LinksEName == "Copy of Customer Enquiry" && c.OptionEName == "Add") && e.ButtonID == "btnNewVersion")
			{
				e.Enabled = false;
			}
