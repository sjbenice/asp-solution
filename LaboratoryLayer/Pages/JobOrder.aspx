<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.Master" CodeBehind="JobOrder.aspx.cs" Inherits="LaboratoryLayer.Pages.JobOrder" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="btn-toolbar">
        ...
        <dx:ASPxLabel ID="lblAttachCount" runat="server" Text="0" ClientVisible="false"></dx:ASPxLabel>
        ...
        <dx:ASPxFormLayout ID="flJobOrderMaster" runat="server" KeyFieldName="JobOrderMasterID" DataSourceID="JobOrderMasterDS" ClientInstanceName="flJobOrderMaster">
            <Items>
                <dx:LayoutGroup ShowCaption="False" ColCount="8">
                    <Items>
                        ...
                        <dx:LayoutItem ShowCaption="False" FieldName="IsReporting" HorizontalAlign="Right" Height="40">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxCheckBox ID="IsReporting" runat="server" Text="Reporting" TextAlign="Right"></dx:ASPxCheckBox>
                                </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                        ...
                        <dx:LayoutItem Caption="Contract Name" FieldName="ContractName" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                                                        <dx:ASPxTextBox ID="txtContractName" ClientInstanceName="txtContractName" 
                                                                            runat="server" >
                                                                             <ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            <RequiredField IsRequired="true" ErrorText="Enter Contract Name!" />
                          ...
                          <dx:LayoutItem Caption="Contract Number" FieldName="ContactNumber" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <dx:ASPxTextBox ID="txtContractNumber" ClientInstanceName="txtContractNumber" 
                                                                            runat="server" >
                                                                             <ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                                            <RequiredField IsRequired="true" ErrorText="Enter Contract Number!" />
                        ...
                        <dx:LayoutItem Caption="Email" FieldName="Email" ColSpan="2">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                     <dx:ASPxTextBox ID="txtEmail" ClientInstanceName="txtEmail" 
                                                                            runat="server" >
                                                                             <ValidationSettings ValidateOnLeave="true" ValidationGroup="OnSave" Display="Dynamic" ErrorDisplayMode="ImageWithTooltip">
                        ...
                        <dx:LayoutItem Caption="Attachments" ColSpan="4" Name="Attachments">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer>
                                    <a target='blank' style="display: block; padding-left: 2px; text-wrap: avoid; width: 30px" onclick='return ShowAttachmentWindow(event, this);' href="../Pages/Attachments.aspx?TransTypeID=11111&TransID=<%#(lblMasterId.Text)%>" title="Attachments"><span runat="server" class="badge" id="attchCount"><%#(lblAttachCount.Text)%></span></a>
                            </dx:LayoutItemNestedControlContainer>
                            </LayoutItemNestedControlCollection>
                        </dx:LayoutItem>
                                    ...
                                    <dx:ASPxGridView runat="server" ID="GdvJobOrderDetailsList" AutoGenerateColumns="false" ClientInstanceName="gridJobOrderDetailsList" OnCellEditorInitialize="GdvJobOrderDetailsList_CellEditorInitialize"
                                        ...
                                        <Columns>
                                            ...
                                            <dx:GridViewDataComboBoxColumn FieldName="FKTestID" Caption="Standard Number" VisibleIndex="4" ReadOnly="true"  Width="8%">
                                                <PropertiesComboBox ValueField="TestID" TextField="StandardNumber" DataSourceID="TestsList12DS">
                                                </PropertiesComboBox>                                                
                                             <Settings AutoFilterCondition="Contains"/>
                                            </dx:GridViewDataComboBoxColumn>
...
<SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                            ...
                                            <RequiredField IsRequired="true" ErrorText="" />
                                                    ...
                                                    <dx:LayoutItem Caption="Night Shift Percentage" FieldName="NightShiftPerc" ColSpan="2">
                                                     ...
                                                     AllowMouseWheel="false" NumberType="Integer"   ClientInstanceName="txtNightShiftPerc" runat="server" ClientEnabled="false">
<SpinButtons ShowIncrementButtons="False"></SpinButtons>
                                                                </dx:ASPxSpinEdit>
                                                            </dx:LayoutItemNestedControlContainer>
                                                        </LayoutItemNestedControlCollection>
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
    ...
    <asp:ObjectDataSource ID="TestsList12DS" runat="server" OldValuesParameterFormatString="original_{0}" TypeName="BusinessLayer.Pages.TestsListDB"
        SelectMethod="GetAll" DataObjectTypeName="BusinessLayer.TestsList"></asp:ObjectDataSource>
